...
export default class DateInput extends React.Component {
  ...
  onBlur(e) {
    ...
    if (valid !== oldValid && onValidityChange) {
      onValidityChange(e, valid); // Inform the parent of the new validity
    }
    this.setState({ focused: false, valid });
    if (valid) onChange(e, dateValue);
  }

  // Check for validity -- only digits and '-' are allowed
  onChange(e) {
  ...
  render() {
    ...
    return (
      <input
        {...props} // Pass the properties through to the <input> element
        value={displayValue}
